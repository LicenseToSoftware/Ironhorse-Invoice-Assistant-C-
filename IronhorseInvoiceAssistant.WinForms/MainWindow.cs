    ...
    public partial class MainWindow : Form
    {
        ...
        private async void resizePhoto_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Show progress form that will receive progress updates from the processing task and update the UI accordingly
                using var progressForm = new ProgressBarForm();
                progressForm.Show();

                // Create a progress reporter that will receive updates from the image processing task and update the progress form accordingly
                ...
                // Process the images in a background task to avoid blocking the UI thread, and pass the progress reporter to receive updates while also updating the progress form.
